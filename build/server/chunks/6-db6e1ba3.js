...
import { B as BLIKK_ESCAPE_SECRET, d as db } from './mysql-c2b6bb75.js';
import 'mysql';
...
const index = 6;
const component = async () => (await import('./_page.svelte-a6dc3c17.js')).default;
const server_id = "src/routes/setup/+page.server.js";
const imports = ["_app/immutable/entry/setup-page.svelte.012a5a1e.js","_app/immutable/chunks/index.5e7f823c.js"];
const stylesheets = [];
const fonts = [];

export { component, fonts, imports, index, _page_server as server, server_id, stylesheets };
//# sourceMappingURL=6-db6e1ba3.js.map
