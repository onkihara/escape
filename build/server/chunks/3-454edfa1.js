...
const index = 3;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-02494522.js')).default;
const server_id = "src/routes/createhouse/+page.server.js";
const imports = ["_app/immutable/nodes/3.4451790f.js","_app/immutable/chunks/index.08ce21f5.js"];
const stylesheets = [];
const fonts = [];

export { component, fonts, imports, index, _page_server as server, server_id, stylesheets };
//# sourceMappingURL=3-454edfa1.js.map
