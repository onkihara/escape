...
const BLIKK_ESCAPE_SECRET = "akfjkafjdkf8q934589245249fakfö-kfja48394502öasd.7";
const BLIKK_ESCAPE_DBHOST = "10.240.167.17";
const BLIKK_ESCAPE_DBNAME = "escape";
const BLIKK_ESCAPE_DBUSER = "escape_user";
const BLIKK_ESCAPE_DBPASS = "$%hieROgraph98itis194§§";
const db = {
  connect,
  close,
  getPlayer,
...
export { BLIKK_ESCAPE_SECRET as B, db as d };
//# sourceMappingURL=mysql-c2b6bb75.js.map
