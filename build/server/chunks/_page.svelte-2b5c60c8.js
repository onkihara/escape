import { c as create_ssr_component, e as escape, d as add_attribute } from './index3-f58250d6.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `<div class="esc_center"><div class="esc_center" style="${"background-image:url(" + escape(login_bg, true) + ");"}"><h2>Escape!</h2>
...
//# sourceMappingURL=_page.svelte-2b5c60c8.js.map
